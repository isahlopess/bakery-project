                        ...
                        {items.length > 0 && (
                            <div className="p-6 border-t border-[var(--color-pao-dourado)]/15 bg-[var(--color-creme)] flex-shrink-0">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button className="flex-1 bg-[var(--color-terracota)] text-white font-bold text-sm py-3 rounded-xl hover:bg-[var(--color-marrom-cafe)] transition-colors shadow-lg shadow-[var(--color-terracota)]/20">
                                        Finalizar Compra
                                    </button>
                                </div>
                            </div>
